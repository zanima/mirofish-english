"""
API retry mechanism
Logic for retrying external API calls such as LLM
"""
            ...
            for attempt in range(max_retries + 1):
                try:
                    ...
                    logger.warning(
                        ...
                        f"Retrying after {current_delay:.1f} seconds..."
                    )
...
class RetryableAPIClient:
    ...
    def call_with_retry(
        ...
        **kwargs
        ...
        """
        Execute function call and retry on failure
    ...
    def call_batch_with_retry(
        ...
        """
        Batch call and retry each failed item separately
        
        Args:
            items: list of items to process
            process_func: processing function, receives a single item as parameter
        ...
        Returns:
            (success result list, failure item list)
        """
        results = []
        failures = []
