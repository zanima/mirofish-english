...
Used to persist project state on the server side, avoiding the front-end from transmitting large amounts of data between interfaces
"""
...
class ProjectStatus(str, Enum):
    """Project Status"""
    CREATED = "created"              # Just created, file already uploaded
...
class Project:
    ...
    # Ontology information (filled after interface 1 generates)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph information (filled after interface 2 completes)
