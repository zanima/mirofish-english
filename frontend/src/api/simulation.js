...
/**
 * Real-time fetch generating Agent Profiles
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Real-time fetch generating simulation configuration
 * @param {string} simulationId
 * @returns {Promise} Return configuration information, including metadata and configuration content
 */
