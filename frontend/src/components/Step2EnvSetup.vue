    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a simulation instance and fetch world parameter templates
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Leverage context to extract entities and relationships from the knowledge graph, initialize simulated individuals, and assign them unique behaviors and memories based on real-world seeds
          </p>
          ...
          <div v-if="profiles.length > 0" class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">Linked Topics</span>
            </div>
          </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently configures world time flow, recommendation algorithms, activity windows, posting frequency, and event triggers based on simulation needs and real-world seeds
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Agent Settings</span>
            ...
            <div class="config-block">
              <div class="config-block-header">
                <span class="config-block-title">Recommendation Settings</span>
              </div>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Initial Activation Plan</span>
          </div>
          <div class="step-status">
            <span v-if="phase > 3" class="badge success">Done</span>
            <span v-else-if="phase === 3" class="badge processing">Planning</span>
            <span v-else class="badge pending">Waiting</span>
          </div>
        </div>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Automatically generates initial activation events and hot topics from the narrative direction to shape the starting state of the simulation world.
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <p class="description">The simulation environment is ready. You can start the run.</p>
          
          <!-- Simulation Rounds Configuration - Only displayed after config generation is complete and rounds are calculated -->
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                <span class="section-title">Simulation Rounds</span>
                <span class="section-desc">MiroFish plans <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours of real-world evolution, with each round representing <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes.</span>
              </div>
              ...
              <div v-if="useCustomRounds" class="rounds-content custom" key="custom">
                <div class="slider-display">
                  ...
                  <div class="slider-meta-info">
                    <span>For 100 agents: estimated runtime about {{ Math.round(customMaxRounds * 0.6) }} minutes</span>
                  </div>
                </div>
                  ...
                  <div class="auto-content">
                    <div class="auto-meta-row">
                      <span class="duration-badge">
                        ...
                        For 100 agents: estimated runtime {{ Math.round(autoGeneratedRounds * 0.6) }} minutes
                      </span>
                    </div>
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">For a first run, we strongly recommend switching to custom mode and reducing the round count so you can preview results faster and lower the chance of errors. ➝</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="selectedProfile" class="profile-modal-overlay" @click.self="selectedProfile = null">
        ...
        <div class="modal-body">
          ...
          <div class="modal-info-grid">
            <div class="info-item">
              <span class="info-label">Visible Age</span>
              <span class="info-value">{{ selectedProfile.age || '-' }} yrs</span>
            </div>
            <div class="info-item">
              <span class="info-label">Visible Gender</span>
            ...
            <div class="info-item">
              <span class="info-label">Visible MBTI</span>
          ...
          <div class="modal-section" v-if="selectedProfile.interested_topics?.length">
            <span class="section-label">Topics from Real-World Seeds</span>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                ...
                <span class="dim-desc">Complete behavior trajectory within this event</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Behavior Pattern Profile</span>
                <span class="dim-desc">Lessons learned and preferred ways of acting</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Distinctive Memory Imprints</span>
                <span class="dim-desc">Memories formed from real-world seeds</span>
              </div>
              <div class="dimension-card">
                <span class="dim-title">Social Relationship Network</span>
                <span class="dim-desc">The individual's links and interaction graph</span>
              </div>
            </div>
...
const customMaxRounds = ref(40)   // Default recommendation of 40 rounds
...
watch(currentStage, (newStage) => {
  if (newStage === 'Generating Agent Profiles' || newStage === 'generating_profiles') {
    ...
    phase.value = 2 // Still belongs to config phase
  }
})

// Calculate auto-generated rounds from config (without using hardcoded default values)
const autoGeneratedRounds = computed(() => {
  ...
  // Ensure max rounds is not less than 40 (recommended value), to avoid slider range anomalies
...
// Get corresponding username based on agent_id
...
// Calculate total number of related topics for all personas
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    ...
    addLog(`Starting simulation with auto-generated rounds: ${autoGeneratedRounds.value}`)
  }
...
// Auto-start preparing simulation
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.already_prepared) {
        addLog('Detected an existing prepared environment, reusing it directly')
      ...
      // Immediately set expected total Agent count (obtained from prepare API response)
    ...
    if (res.success && res.data) {
      ...
      if (data.config_generated && data.config) {
        ...
        if (data.summary) {
          ...
          addLog(`  └─ Platform configs: Twitter ${data.summary.has_twitter_config ? '✓' : '✗'}, Reddit ${data.summary.has_reddit_config ? '✓' : '✗'}`)
        }
        ...
        stopConfigPolling()
        phase.value = 4
        addLog('✓ Environment setup complete, ready to start the simulation')
  ...
  try {
    ...
    if (res.success && res.data) {
      if (res.data.config_generated && res.data.config) {
        ...
        addLog('Configuration is still being generated, waiting with polling...')
        startConfigPolling()
      }
    }
  } catch (err) {
